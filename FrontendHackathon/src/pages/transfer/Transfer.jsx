...
function Transfer() {
    ...
    const [toAcc, setToAcc] = useState(sessionStorage.getItem("toAcc")?sessionStorage.getItem("toAcc"):"");
    const [amount, setAmount] = useState(sessionStorage.getItem("amount")?sessionStorage.getItem("amount"):"");
    const [description, setDescription] = useState(sessionStorage.getItem("description")?sessionStorage.getItem("description"):"");
